...
| 이름 | 담당 기능 | 개인 github |
| --- | --- | --- |
| **노경민** | 로그인/회원가입, 마이페이지, 쿠폰 기능 | https://github.com/ihan0412 |
| **이재원** | 메일 서비스, AI 도우미 기능 | https://github.com/ljwn1721 |
| **장중원** | 상품 도메인 및 검색,  장바구니, 예약/주문 기능 | https://github.com/BlueStar-jjw |
## 핵심 기능 
#### 로그인/인증
- 회원가입
- 로그인 - JWT 토큰 인증
